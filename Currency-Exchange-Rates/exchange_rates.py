...
amount = input(
    f"\033cEnter amount of {currency['name'].lower()}s (if amount isn\'t integer, then write it with a dot, not comma): "
)
...
print(f"\033cFor {amount} {currency['name'].lower()}s you\'ll get:")
